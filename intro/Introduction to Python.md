...
Perintah untuk menginstall Jupyter Notebook
...
List dan tuple merupakan salah satu struktur data yang disediakan oleh Python. Secara struktur, yang membedakan adalah mutability dari keduanya. List mutable sedangkan tuple immutable. [Great explanation](https://www.afternerd.com/blog/difference-between-list-tuple/).

Dalam mendeklarasikan list, ada dua cara yang umum digunakan.
...
Untuk contoh penggunaan ada di Jupyter dan Repl.it
